...
var UltronTerminalExecutor = /** @class */ (function () {
    ...
    UltronTerminalExecutor.getInstance = function (commandHandler, shellExecutor, terminalInputted) {
        if (!this.INSTANCE) {
            this.INSTANCE = new UltronTerminalExecutor(commandHandler, shellExecutor, terminalInputted);
        }
        return this.INSTANCE;
    };
    UltronTerminalExecutor.prototype.getEnvs = function () {
        return {
    ...
    UltronTerminalExecutor.prototype.initCli = function () {
        return __awaiter(this, void 0, void 0, function () {
            var project, projectsPaths, currentProjectPath, flagOptions, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        this.commandHandler.option("--e, --env envType", "environment", "red");
                        return [4 /*yield*/, this.terminalInputted.prompt([
                                {
                                    type: "list",
                                    name: "projectName",
                    ...
                    case 1:
                        project = _a.sent();
                        projectsPaths = this.getEnvs();
                        currentProjectPath = projectsPaths[project];
                        this.shellExecutor.exec("code " + currentProjectPath);
                        this.shellExecutor.cd(projectsPaths.ultronMainProject);
                        flagOptions = this.commandHandler.opts();
    ...
    return UltronTerminalExecutor;
}());
exports.UltronTerminalExecutor = UltronTerminalExecutor;
